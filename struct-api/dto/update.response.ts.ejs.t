---
to: "<%= struct.generateEnable ? `${rootDirectory}/api/src/app/endpoint/${struct.name.lowerKebabName}/dto/update-${struct.name.lowerKebabName}.response.generated.ts` : null %>"
force: true
---

---
to: "<%= struct.generateEnable ? `${rootDirectory}/api/src/module/${struct.name.lowerKebabName}/${struct.name.lowerKebabName}.module.ts` : null %>"
force: true
---
...
import {<%= struct.name.pascalName %>Repository} from "../../infrastructure/database/<%= struct.name.lowerKebabName %>.repository";
